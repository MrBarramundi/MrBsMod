package com.mrbarramundi.mrbsmod.objects.blocks;
 ...
 * Author: MrCrayfish
 */
public class DiamondBladedStonecutterBlock extends Block
{
    private static final TranslationTextComponent CONTAINER_TITLE = new TranslationTextComponent("container.diamondbladedstonecutter.diamondbladedstonecutter");
    ...
    public DiamondBladedStonecutterBlock(Properties properties)
    {
        super(properties);
    ...
    public INamedContainerProvider getContainer(BlockState state, World world, BlockPos pos)
    {
        return new SimpleNamedContainerProvider((windowId, playerInventory, playerEntity) -> {
            return new DiamondBladedStonecutterContainer(windowId, playerInventory, IWorldPosCallable.of(world, pos));
        }, CONTAINER_TITLE);
    }
